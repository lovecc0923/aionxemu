...
public class GoodsBonus extends AbstractInventoryBonus {
    ...
    /* (non-Javadoc)
      * @see gameserver.itemengine.bonus.AbstractInventoryBonus#apply(com.aionemu.gameserver.model.gameobjects.player.Player, com.aionemu.gameserver.model.gameobjects.Item)
      */
    ...
    /* (non-Javadoc)
      * @see gameserver.itemengine.bonus.AbstractInventoryBonus#canApply(com.aionemu.gameserver.model.gameobjects.player.Player, com.aionemu.gameserver.model.gameobjects.Item, int)
      */
