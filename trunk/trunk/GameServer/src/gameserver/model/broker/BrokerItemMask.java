...
public enum BrokerItemMask {
    ...
    CRAFT_DESIGN_WEAPONSMITHING(6040, new BrokerContainsFilter(1522), BrokerItemMask.CRAFT_DESIGN, false),
    CRAFT_DESIGN_ARMORSMITHING(6041, new BrokerContainsFilter(1522), BrokerItemMask.CRAFT_DESIGN, false),
    CRAFT_DESIGN_TAILORING(6042, new BrokerContainsFilter(1522), BrokerItemMask.CRAFT_DESIGN, false),
    CRAFT_DESIGN_HANDICRAFTING(6043, new BrokerContainsFilter(1522), BrokerItemMask.CRAFT_DESIGN, false),
    CRAFT_DESIGN_ALCHEMY(6044, new BrokerContainsFilter(1522), BrokerItemMask.CRAFT_DESIGN, false),
    CRAFT_DESIGN_COOKING(6045, new BrokerContainsFilter(1522), BrokerItemMask.CRAFT_DESIGN, false),

    /**
     * Consumables Section + sub categories
     */
    CONSUMABLES(9060, new BrokerContainsFilter(1410, 1600, 1620, 1640, 1690, 1694), null, true),
    ...
    CONSUMABLES_MODIFY(8060, new BrokerContainsFilter(1660, 1670, 1680, 1692), BrokerItemMask.CONSUMABLES, true),
    ...
    CONSUMABLES_OTHER(7062, new BrokerContainsFilter(1410, 1690, 1694), BrokerItemMask.CONSUMABLES, false), // TODO

    /**
     * Other Section
     */
    OTHER(7070, new BrokerContainsFilter(1860, 1880), null, false), // TODO
