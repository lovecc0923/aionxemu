...
public class _3071PlatinumPriest48 extends QuestHandler {

    static QuestsData questsData = DataManager.QUEST_DATA;
    private final static int questId = 3071;

    public _3071PlatinumPriest48() {
        super(questId);
    }

    @Override
    public void register() {
        qe.setNpcQuestData(798175).addOnQuestStart(questId);
        qe.setNpcQuestData(798175).addOnTalkEvent(questId);
    }
