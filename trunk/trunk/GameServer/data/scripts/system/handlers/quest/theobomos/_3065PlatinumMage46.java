...
public class _3065PlatinumMage46 extends QuestHandler {

    static QuestsData questsData = DataManager.QUEST_DATA;
    private final static int questId = 3065;

    public _3065PlatinumMage46() {
        super(questId);
    }

    @Override
    public void register() {
        qe.setNpcQuestData(798174).addOnQuestStart(questId);
        qe.setNpcQuestData(798174).addOnTalkEvent(questId);
    }
