 ...
 *
 */
public class _28625KaligasCollection extends QuestHandler {
    private final static int questId = 28625;

    public _28625KaligasCollection() {
        super(questId);
    }

    @Override
    public void register() {
        qe.setNpcQuestData(730333).addOnQuestStart(questId); //Lacchus
        qe.setNpcQuestData(730333).addOnActionItemEvent(questId);
        qe.setNpcQuestData(730333).addOnTalkEvent(questId);
    }
