...
public class _2505LetCookingExpertsCook extends QuestHandler {
	...
	if(targetId == 204720)
	{
		if(qs == null || qs.getStatus() == QuestStatus.NONE)
		{
			...
			{
				if (ItemService.addItems(player, Collections.singletonList(new QuestItems(182204404, 1))))
	...
	if(targetId == 204731)
	{
		switch(env.getDialogId())
		{
			...
			case 10000:
				if(var == 0)
				{
					player.getInventory().removeFromBagByItemId(182204404, 1);
					if (!ItemService.addItems(player, Collections.singletonList(new QuestItems(182204405, 1))))
