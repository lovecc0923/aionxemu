...
public class _3929TheChanterPreceptorsTask extends QuestHandler {
    private final static int questId = 3929;
    private final int skillId = 1328;
    private final int mainNpcId = 203707;

    public _3929TheChanterPreceptorsTask() {
        super(questId);
    }
