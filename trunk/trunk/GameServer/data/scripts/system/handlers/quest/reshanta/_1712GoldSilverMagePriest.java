...
public class _1712GoldSilverMagePriest extends QuestHandler {

    private final static int questId = 1712;
    static QuestsData questsData = DataManager.QUEST_DATA;

    public _1712GoldSilverMagePriest() {
        super(questId);
    }

    @Override
    public void register() {
        qe.setNpcQuestData(278524).addOnQuestStart(questId);
        qe.setNpcQuestData(278524).addOnTalkEvent(questId);
