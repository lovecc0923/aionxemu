...
public class _1713SilverScoutWarrior36 extends QuestHandler {

    private final static int questId = 1713;
    static QuestsData questsData = DataManager.QUEST_DATA;

    public _1713SilverScoutWarrior36() {
        super(questId);
    }

    @Override
    public void register() {
        qe.setNpcQuestData(278638).addOnQuestStart(questId);
        qe.setNpcQuestData(278638).addOnTalkEvent(questId);
