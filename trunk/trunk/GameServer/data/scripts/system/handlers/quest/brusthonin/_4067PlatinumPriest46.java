 ...
 *
 */
public class _4067PlatinumPriest46 extends QuestHandler {

    static QuestsData questsData = DataManager.QUEST_DATA;
    private final static int questId = 4067;

    public _4067PlatinumPriest46() {
        super(questId);
    }

    @Override
    public void register() {
        qe.setNpcQuestData(205163).addOnQuestStart(questId);
        qe.setNpcQuestData(205163).addOnTalkEvent(questId);
    }
