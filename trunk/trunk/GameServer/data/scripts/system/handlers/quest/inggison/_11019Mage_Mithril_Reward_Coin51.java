 ...
 * @author dta3000
 */
public class _11019Mage_Mithril_Reward_Coin51 extends QuestHandler {

    static QuestsData questsData = DataManager.QUEST_DATA;
    private final static int questId = 11019;

    public _11019Mage_Mithril_Reward_Coin51() {
        super(questId);
    }

    @Override
    public void register() {
        qe.setNpcQuestData(798916).addOnQuestStart(questId);
        qe.setNpcQuestData(798916).addOnTalkEvent(questId);
    }
