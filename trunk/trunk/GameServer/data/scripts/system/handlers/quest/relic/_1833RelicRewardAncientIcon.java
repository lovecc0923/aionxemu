...
public class _1833RelicRewardAncientIcon extends QuestHandler {
    private final static int questId = 1833;

    public _1833RelicRewardAncientIcon() {
        super(questId);
    }

    @Override
    public void register() {
        qe.setNpcQuestData(278644).addOnQuestStart(questId); //Lacchus
