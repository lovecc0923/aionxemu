...
public class _3922TheGladiatorPreceptorsTask extends QuestHandler {
    private final static int questId = 3922;
    private final int skillId = 272;
    private final int mainNpcId = 203704;

    public _3922TheGladiatorPreceptorsTask() {
        super(questId);
    }
