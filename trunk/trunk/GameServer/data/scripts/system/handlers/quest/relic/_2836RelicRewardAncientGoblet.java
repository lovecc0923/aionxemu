...
public class _2836RelicRewardAncientGoblet extends QuestHandler {
    private final static int questId = 2836;

    public _2836RelicRewardAncientGoblet() {
        super(questId);
    }

    @Override
    public void register() {
        qe.setNpcQuestData(278146).addOnQuestStart(questId); //Tiele
        qe.setNpcQuestData(278146).addOnTalkEvent(questId);
    }
