...
public class _1714SilverPriestMage extends QuestHandler {

    private final static int questId = 1714;
    static QuestsData questsData = DataManager.QUEST_DATA;

    public _1714SilverPriestMage() {
        super(questId);
    }

    @Override
    public void register() {
        qe.setNpcQuestData(278639).addOnQuestStart(questId);
        qe.setNpcQuestData(278639).addOnTalkEvent(questId);
