...
public class _1711GoldSilverScoutWarrior extends QuestHandler {

    private final static int questId = 1711;
    static QuestsData questsData = DataManager.QUEST_DATA;

    public _1711GoldSilverScoutWarrior() {
        super(questId);
    }

    @Override
    public void register() {
        qe.setNpcQuestData(278523).addOnQuestStart(questId);
        qe.setNpcQuestData(278523).addOnTalkEvent(questId);
        ...
        if (targetId == 278523) {
            if (qs == null || qs.getStatus() == QuestStatus.NONE) {
                ...
                if (env.getDialogId() == 2) {
                    ...
                    if (player.getInventory().getItemCountByItemId(186000004) >= 10) {
