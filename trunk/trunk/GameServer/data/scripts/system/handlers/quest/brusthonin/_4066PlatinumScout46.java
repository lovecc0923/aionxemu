 ...
 *
 */
public class _4066PlatinumScout46 extends QuestHandler {

    static QuestsData questsData = DataManager.QUEST_DATA;
    private final static int questId = 4066;

    public _4066PlatinumScout46() {
        super(questId);
    }

    @Override
    public void register() {
        qe.setNpcQuestData(205161).addOnQuestStart(questId);
        qe.setNpcQuestData(205161).addOnTalkEvent(questId);
    }
