...
public class _2847ItsAllBalaurtoMe extends QuestHandler {
    private final static int questId = 2847;
    ...
    public void register() {
        qe.setNpcQuestData(278020).addOnTalkEvent(questId);
        qe.setNpcQuestData(279005).addOnTalkEvent(questId);
        qe.setNpcQuestData(798063).addOnTalkEvent(questId);
    }
    ...
    public boolean onDialogEvent(QuestCookie env) {
        ...
        } else if (qs.getStatus() == QuestStatus.REWARD && targetId == 798063) {
            return defaultQuestEndDialog(env);
        }
        return false;
    }
