 ...
 * @author dta3000
 */
public class _11017Warrior_Mithril_Reward_Coin51 extends QuestHandler {

    static QuestsData questsData = DataManager.QUEST_DATA;
    private final static int questId = 11017;

    public _11017Warrior_Mithril_Reward_Coin51() {
        super(questId);
    }

    @Override
    public void register() {
        qe.setNpcQuestData(798914).addOnQuestStart(questId);
        qe.setNpcQuestData(798914).addOnTalkEvent(questId);
    }
