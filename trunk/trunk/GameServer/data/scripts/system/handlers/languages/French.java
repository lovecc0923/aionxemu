...
public class French extends Language {
    public French() {
        ...
        addTranslatedMessage(CustomMessageId.COMMAND_ADD_ADMIN_SUCCESS, "Item(s) ajouté(s) à %s avec succès");
        addTranslatedMessage(CustomMessageId.COMMAND_ADD_PLAYER_SUCCESS, "%s vous a ajouté %d item(s)");
        addTranslatedMessage(CustomMessageId.COMMAND_ADD_FAILURE, "L'item %d n'existe pas et/ou ne peut pas être ajouté à %s");
        ...
        addTranslatedMessage(CustomMessageId.COMMAND_ADDSET_SET_DOES_NOT_EXISTS, "L'ensemble %d n'existe pas");
        ...
        addTranslatedMessage(CustomMessageId.COMMAND_ADDSET_CANNOT_ADD_ITEM, "L'item %d ne peut pas être ajouté à %s");
        addTranslatedMessage(CustomMessageId.COMMAND_ADDSET_ADMIN_SUCCESS, "L'ensemble d'items %d a été ajouté à %s avec succès");
        addTranslatedMessage(CustomMessageId.COMMAND_ADDSET_PLAYER_SUCCESS, "%s vous a ajouté un ensemble d'items");
        ...
        addTranslatedMessage(CustomMessageId.CHANNEL_BAN_ENDED, "Vous n'êtes plus banni des canaux de chat");
        addTranslatedMessage(CustomMessageId.CHANNEL_BAN_ENDED_FOR, "Le joueur %s n'est plus banni des canaux de chat");
